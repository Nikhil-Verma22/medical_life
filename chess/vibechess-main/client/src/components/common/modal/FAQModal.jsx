...
function FAQModal({ isOpen, onClose }) {
	...
	const faqData = [
		...
		{
			question: "Can I chat with my opponent?",
			answer: "In-app chat isn't available on this platform, for everyone's safety. If you'd like to talk with a friend you're playing, feel free to use WhatsApp, Discord, or any platform you trust.",
		},
	];
