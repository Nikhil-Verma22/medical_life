...
function SettingsModal({ isOpen, onClose, onBoardChange, onPiecesChange, isIngame = false }) {
	...
	const [backgroundEffect, setBackgroundEffect] = useState(
		window.localStorage.getItem("backgroundEffect") || "none"
	);
	...
	const handleBackgroundEffectChange = (event) => {
		const newValue = event.target.value;
		setBackgroundEffect(newValue);
		window.localStorage.setItem("backgroundEffect", newValue);
		window.dispatchEvent(
			new CustomEvent("backgroundEffectChanged", {
				detail: { backgroundEffect: newValue },
			})
		);
	};
			...
			<Fade in={isOpen}>
				...
				>
					...
					>
						...
						>
							<MenuItem value="medicalTeal">
								Medical Teal
							</MenuItem>
							<MenuItem value="classicMono">
								Classic B&amp;W
							</MenuItem>
							<MenuItem value="darkSlate">Dark Slate</MenuItem>
							<MenuItem value="emeraldScrub">
								Emerald Scrub
							</MenuItem>
							<MenuItem value="royalNavy">Royal Navy</MenuItem>
							<MenuItem value="minimalMono">
								Minimal Mono
							</MenuItem>
							<MenuItem value="sunsetCoral">
								Sunset Coral
							</MenuItem>
						</Select>
					</Box>
					...
					>
						...
						>
							...
							<MenuItem value="pulsating">Pulsating</MenuItem>
